...
from backend.services import body_metric_service, export_service
...
def export_workout_sessions(
    ...
    # BLOCKER: WorkoutSession and WorkoutSet models are not yet implemented in the repository.
    # Returning 501 to indicate functionality is planned but source data is missing.
    raise HTTPException(
        status_code=status.HTTP_501_NOT_IMPLEMENTED,
        detail="Workout Logging (Sessions/Sets) implementation is missing. Export will be available once the teammate completes those models."
    )
